## Практическое задание для курса "Оптимизирующие компиляторы"
...
4. Постройте Control Flow Graph для этого теста:
    ...
    Note: можете также использовать скрипт generate-cfgs.sh для построения CFG.  
    Usage:
    ```sh
    $ ./generate-cfgs.sh /path/to/llvm-project/build/bin/opt sink.ll
    ```

5. Добавьте оптимизационные пассы в пайплайн:  
...
### Задание 2. Строим свой пайплайн

Подробно задание описано в [Benchmarks/README.md](Benchmarks/README.md)
